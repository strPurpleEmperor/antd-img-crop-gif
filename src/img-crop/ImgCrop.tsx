...
export const ImgCrop = forwardRef<CropperRef, ImgCropProps>(
  (props, cropperRef) => {
    const {
      quality = 0.4,
      fillColor = 'white',
    ...
    const cropGif = useCallback((file: RcFile) => {
      ...
      return init()
        ...
        .then((arrayBuffer) => {
          ...
          const cropGifU8Array = crop_gif(uint8Array, width, height, x, y);
    ...
    const getNewBeforeUpload = useCallback(
      ...
      [getCropCanvas, quality, runBeforeUpload, cropGif],
    );
